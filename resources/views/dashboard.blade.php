...
<div class="min-h-screen flex flex-col items-center justify-center" style="scroll-behavior: smooth;">
    <div class="min-h-screen w-full flex justify-center bg-auth-bg bg-cover">
        <a href="#visi-misi" class="text-white bg-primary px-10 py-2 h-full mt-[375px] font-semibold rounded-lg">Jelajahi</a>
    </div>
    <div id="visi-misi" class="text-center w-3/5 flex flex-col gap-16 py-20 justify-evenly">
        <div>
    ...
    <div id="about-us" class="bg-[#E1EEE5] w-full py-12">
        <div class="w-3/5 text-center mx-auto flex flex-col gap-8 py-10 justify-evenly">
    ...
    <div id="faqs" class="w-full py-16 px-24">
        <p class="text-center text-3xl font-bold">Frequently Asked Questions</p>
        <div class="w-4/5 flex flex-row justify-between items-center mx-auto py-4">
