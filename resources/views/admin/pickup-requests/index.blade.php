...
<div class="mx-auto w-4/5 py-8 min-h-screen">
    ...
    <div class="w-full flex justify-between items-center px-8 py-6 border border-gray-300 rounded-lg">
        <div class="w-1/4 font-medium flex flex-col gap-3 ">
        ...
        <div class="w-2/4 font-medium flex flex-col gap-3 border-x px-24 border-gray-300">
        ...
        <div class="w-1/4 font-medium justify-center items-center flex flex-col gap-3">
